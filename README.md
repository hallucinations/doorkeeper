...
- [Protecting resources with OAuth (a.k.a your API endpoint)](#protecting-resources-with-oauth-aka-your-api-endpoint)
  ...
  - [API Only option for use with Rails API](#api-only-option-for-use-with-rails-api)
...
By default, Doorkeeper comes with a user interface showing the list of registered client applications as well as authorized applications list for an authorized resource owner. If you have a Rails API application and don't need this feature, you can disable it with the :api_only option in the use_doorkeeper block in your routes.rb file as follows:
